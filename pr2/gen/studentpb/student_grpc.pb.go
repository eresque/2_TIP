...
type StudentServiceClient interface {
	...
	ListStudents(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListStudentsResponse, error)
...
func (c *studentServiceClient) ListStudents(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListStudentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type StudentServiceServer interface {
	...
	ListStudents(context.Context, *emptypb.Empty) (*ListStudentsResponse, error)
...
func (UnimplementedStudentServiceServer) ListStudents(context.Context, *emptypb.Empty) (*ListStudentsResponse, error) {
...
func _StudentService_ListStudents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudentServiceServer).ListStudents(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
